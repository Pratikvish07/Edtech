...
export const EditLeadModal: React.FC<EditLeadModalProps> = ({ isVisible, onClose, newLead, setNewLead, onUpdate, isDarkMode }) => {
        ...
        <LinearGradient colors={isDarkMode ? ['#1F2937', '#111827'] : ['#F8FAFC', '#E2E8F0']} className="rounded-t-3xl shadow-2xl p-6 pb-8">
          <View className="flex-row justify-between items-center mb-6">
            <View className="flex-row items-center">
              ...
              <Text className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Edit Lead</Text>
            </View>
          ...
          <ScrollView showsVerticalScrollIndicator={false} className="max-h-80">
            ...
            <View className="flex-row justify-between mt-2 space-x-4">
              <LinearGradient colors={['#F59E0B', '#D97706']} className="flex-1 rounded-2xl shadow-lg">
                <TouchableOpacity onPress={onUpdate} className="p-4 items-center">
                  <View className="flex-row items-center">
                    <Ionicons name="checkmark-circle-outline" size={20} color="white" className="mr-2" />
                    <Text className="text-white text-center font-bold text-lg">Update Lead</Text>
                  </View>
                </TouchableOpacity>
              </LinearGradient>
