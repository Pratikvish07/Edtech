    ...
    <View className={`flex-1 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <Modal visible={showAddUserModal} animationType="slide" transparent>
        <View className="flex-1 justify-end bg-black bg-opacity-60">
          <Animated.View style={{ transform: [{ translateY: slideAnim }] }} className="bg-transparent">
            <LinearGradient colors={isDarkMode ? ['#1F2937', '#111827'] : ['#F8FAFC', '#E2E8F0']} className="rounded-t-3xl shadow-2xl p-6 pb-8">
              <View className="flex-row justify-between items-center mb-6">
                ...
                <TouchableOpacity onPress={() => setShowAddUserModal(false)} className={`p-2 rounded-full ${isDarkMode ? 'bg-gray-600' : 'bg-gray-200'}`}>
                  <Ionicons name="close" size={24} color={isDarkMode ? 'white' : 'gray'} />
                </TouchableOpacity>
              </View>
              <ScrollView showsVerticalScrollIndicator={false} className="max-h-80">
                ...
                <View className="flex-row justify-between mt-2 space-x-4">
                  <LinearGradient colors={['#10B981', '#059669']} className="flex-1 rounded-2xl shadow-lg">
                    <TouchableOpacity onPress={handleAddUser} className="p-4 items-center">
                      <View className="flex-row items-center">
                  ...
                  <TouchableOpacity onPress={() => setShowAddUserModal(false)} className={`flex-1 p-4 rounded-2xl shadow-lg ${isDarkMode ? 'bg-gray-600' : 'bg-gray-300'}`}>
